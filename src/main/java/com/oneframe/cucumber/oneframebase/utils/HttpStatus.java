...
public enum HttpStatus {
  CONTINUE(100, "Continue"), SWITCHING_PROTOCOL(101, "Switching Protocols"), 
  ...
  MULTIPLE_CHOICES(300, "Multiple Choices"), MOVED_PERMANENTLY(301, "Moved Permanently"), 
  FOUND(302, "Found"),
  ...
  BAD_REQUEST(400, "Bad AlertsRequest"), UNAUTHORIZED(401, "Unauthorized"), 
  PAYMENT_REQUIRED(402, "Payment Required"),
  FORBIDDEN(403, "Forbidden"), NOT_FOUND(404, "Not Found"), 
  METHOD_NOT_ALLOWED(405, "Method Not Allowed"),
  NOT_ACCEPTABLE(406, "Not Acceptable"), 
  PROXY_AUTHENTICATION_REQUIRED(407, "Proxy Authentication Required"),
  REQUEST_TIMEOUT(408, "AlertsRequest Timeout"), CONFLICT(409, "Conflict"), 
  GONE(410, "Gone"),
  ...
  PROXY_DECLINED_REQUEST(523, "Proxy Declined AlertsRequest"),
