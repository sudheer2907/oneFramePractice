...
public class TimeDurationCalculator {
  ...
  /**
   * Calculate the time Difference between two times by {@link #start()} and {@link #stop()}.
   */
  ...
  /**
   * Get the total seconds elapsed between two times by {@link #start()} and {@link #stop()}.
   *
